...
const CookingAmountPicker = (props) => {
    // React Hooks: State
    ...
    const renderIOSPicker = () => {
        try {
            return (react_1.default.createElement(react_native_1.Picker, { selectedValue: tempItem !== undefined ? tempItem : item, onValueChange: (item) => selectItem(item) }, cookingAmounts.map((item) => {
            ...
            if (react_native_1.Platform.OS === 'android') {
                return (react_1.default.createElement(react_native_1.View, { style: styles.container },
                    ...
                    react_1.default.createElement(react_native_1.View, { style: styles.fieldTextContainer },
                        react_1.default.createElement(react_native_1.Picker, { selectedValue: item, style: { height: 60, width: width - 16 }, onValueChange: (item) => selectItem(item), mode: "dropdown" }, cookingAmounts.map((item) => {
                            return (react_1.default.createElement(react_native_1.Picker.Item, { label: item.label, value: item.value, key: item.key || item.label }));
                        })))));
            }
        }
...
// Exports
exports.default = CookingAmountPicker;
